package fr.esipe.ing2.common.configuration;
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "fr.esipe.ing2.common.model" });
	...
	private Properties jpaProperties() {
		...
		properties.put(PROPERTY_NAME_HIBERNATE_DIALECT, environment.getRequiredProperty("datasource.sampleapp.hibernate.dialect"));
		properties.put("hibernate.hbm2ddl.auto", environment.getRequiredProperty("datasource.sampleapp.hibernate.hbm2ddl.method"));
		properties.put(PROPERTY_NAME_HIBERNATE_SHOW_SQL, environment.getRequiredProperty("datasource.sampleapp.hibernate.show_sql"));
